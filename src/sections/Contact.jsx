...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "digvijaybasunde24@gmail.com",
    href: "mailto:digvijaybasunde24@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+91 9325212276",
    href: "tel:+91 9325212276",
  },
  {
    icon: MapPin,
    label: "Location",
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-[var(--color--surface)] rounded-xl border border-border focus:border-[var(--color-primary)] focus:ring-1 focus:ring-[var(--color-primary)] outline-none transition-all"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-surface rounded-xl border border-border focus:border-[var(--color-primary)] focus:ring-1 focus:ring-[var(--color-primary)] outline-none transition-all"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-[var(--color-surface)] rounded-xl border border-border focus:border-[var(--color-primary)] focus:ring-1 focus:ring-[var(--color-primary)] outline-none transition-all resize-none"
                />
              </div>
